  ...
  Widget build(BuildContext context) {
    final List<FormFieldData> formFields = [
      FormFieldData(
        ...
        dropdownItemsWilayah: wilayahResult?.wilayah ?? [Wilayah(id: '', title: '', alias: '', jumlahCalon: '')],
        helperText: null,
      ),
      FormFieldData(
        titleLabel: "Jenis Relawan",
        inputLabel: "Pilih Jenis Relawan",
        dropdownItemsVolunteer: volunteerResult?.volunteer ?? [Volunteer(id: '', tipeRelawan: '')],
        helperText: null,
      ),
      FormFieldData(
      ...
      listener: (context, state) {
        if (state is InitVolunteerLoadedState) {
          ...
          setState(() {
            ...
            formFields[1].dropdownItemsVolunteer = volunteerResult?.volunteer ?? [];
          });
        }
      },
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: QuickcountTextFormField(
                            ...
                            dropdownItems: fieldData.dropdownItemsVolunteer.isNotEmpty ? fieldData.dropdownItemsVolunteer.map((e) => e.tipeRelawan).toList() : fieldData.dropdownItemsWilayah.map((e) => e.title).toList(),
