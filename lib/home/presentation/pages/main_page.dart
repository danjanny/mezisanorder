...
class TwalletBankTransferConfirmPage extends StatefulWidget {
  const TwalletBankTransferConfirmPage({super.key});

  @override
  State<TwalletBankTransferConfirmPage> createState() =>
      _TwalletBankTransferConfirmPageState();
}

class _TwalletBankTransferConfirmPageState
    extends State<TwalletBankTransferConfirmPage> {
  @override
  void initState() {
    super.initState();
  }
